...
const SOURCE = fs.readFileSync(path.join(__dirname, 'Random.sol'), 'utf8');
...
async function main() {
  console.log('Random Contract Verification');
  console.log('Contract: 0x77b7fa1bc7c2e626650393fe04ed3c93c119b6af');
  console.log('Compiler: soljson-v0.1.6+commit.d41f8b7c (optimizer OFF)');
  console.log();
  ...
  const contract = out.contracts['Random'];
