...
const SOURCE = fs.readFileSync(path.join(__dirname, 'ShippingEscrow2.sol'), 'utf8');
const COMPILER_URL = 'https://binaries.soliditylang.org/bin/soljson-v0.1.5+commit.23865e39.js';
const COMPILER_FILE = path.join(__dirname, 'soljson-v0.1.5.js');
...
async function main() {
  console.log('ShippingEscrow2 Contract Verification');
  console.log('Contract: 0x47618f0CbA4E98886F169f2bD9E58F39b8f11b45');
  ...
  const contract = out.contracts['ShippingEscrow2'];
  ...
  if (runtimeMatch) {
    ...
    console.log();
    console.log('Identical clones (same runtime + init):');
    console.log('  0xbfb62a95d7adc28d7e2af3b39ea7255b6922e668');
    console.log('  0xaddDDbD21963Ff1E5619F8B168F804594Cd22b79');
  }
}
